  ...
  return (
    <>
      <div className='w-full p-4 bg-white border border-gray-200 rounded-lg shadow sm:p-8 dark:bg-gray-800 dark:border-gray-700 px-2'>
        ...
        <button
          type='button'
          className='mt-5 text-white bg-blue-600 hover:bg-blue-700 focus:ring-4 focus:outline-none focus:ring-blue-200 dark:focus:ring-blue-900 font-medium rounded-lg text-sm px-5 py-[12px] inline-flex justify-center w-full text-center'
        >
          Place Order
        </button>
      </div>
